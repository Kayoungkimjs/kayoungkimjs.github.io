---
title: "Ssh 알고 설정하기"
datePublished: Sun Oct 09 2022 15:00:00 GMT+0000 (Coordinated Universal Time)
cuid: cm2rjepsp000009mf8cmh5lr7
slug: ssh
tags: shell, ssh
...
![image1.png](https://kayoungkimjs.github.io/static/8b301310cce7697f3d85992a25cb03ef/d9199/image1.png align="left")
...
**2) 대칭키 방식 (Symmetric Encryption)** 암복호화에 사용하는 키가 동일한 암호화 방식

![image2.png](https://kayoungkimjs.github.io/static/f4fbe66bdb775d615ae0410105957a01/d9199/image2.png align="left")
...
* id\_rsa - 비공개키(Private Key), id\_[rsa.pub](http://rsa.pub) - 공개키(Public Key) 페어 생성
...
* Jenkins SSH Key 등록
    ...
    ![image3.png](https://kayoungkimjs.github.io/static/9d3073eee8f7d9f23ff3e5af1ce1c7a1/d9199/image3.png align="left")
    
* SSH Server 생성 후 Test Configuration, Success 뜨면 성공
    
    ![image4.png](https://kayoungkimjs.github.io/static/78f6f36c284eb8181997fd060a5fb0d2/a1dd2/image4.png align="left")
