...
datePublished: Tue Nov 08 2022 15:00:00 GMT+0000 (Coordinated Universal Time)
cuid: cm2rjj5eg000009jnd8po6xiy
slug: 7zse66gc7kcd7yq4ioylnoyekeqzvcdtm4qg7zwo6ruyioqzoouvvo2vtoyvvcdtlaag6rkd65ok
tags: programming-blogs, reactjs, typescript, recoil, emotions, tanstack-query
...
| [**Ant Design**](https://ant.design/components/overview/)**/**[**MUI**](https://mui.com/material-ui/) | UI 프레임워크 | 어드민 페이지 개발에 필요한 컴포넌트가 세분화되어있고 완성도가 높다. AntD보다 디자인이 다양하고, 디테일한 기능을 제공한다. 커스텀에 용이하다.  
\*AntD: 관리자 페이지의 table, form 등에 일부 사용“\*MUI: 이모티콘 사용 |
