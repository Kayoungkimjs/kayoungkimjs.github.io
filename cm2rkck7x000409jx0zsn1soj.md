...
datePublished: Tue Dec 26 2023 15:00:00 GMT+0000 (Coordinated Universal Time)
cuid: cm2rkck7x000409jx0zsn1soj
slug: jenkins-cicd
tags: jenkins, cicd
...
![image3.png](https://kayoungkimjs.github.io/static/1e363938a8d611ed8ca952063d9ba746/2e237/image3.png align="left")

1. **Repository URL**
    
    * 해당 Repository URL 입력([https://git-1.cocone.jp/syf/hello-cocone-front-v2.git](https://git-1.cocone.jp/syf/hello-cocone-front-v2.git) → GitLab &gt; Clone &gt; HTTPS clone 복사)
        
2. **Credentials**
    
    * 추가되어있는 자격증명 키 입력
        
        * 키가 없을 경우 gitlab 레포의 Project information - Members - ‘syf\_jenkins’ (Developer 권한) 추가
...
* 필요에 따라 항목을 선택
    ...
    ![image4.png](https://kayoungkimjs.github.io/static/5d31becf159106a124737573569efd85/eb2af/image4.png align="left")
...
![image6.png](https://kayoungkimjs.github.io/static/81cdba4c310f5cda2b28f2269515a382/e0885/image6.png align="left")
...
1. **Name** publish over SSH 로 설정한 원격 서버
...
3. **Slack Notification** 빌드 경과 슬랙으로 전송 ‘고급’ - Include Custom Message에서 과정 별 메시지 설정 ‘빌드 후 조치 추가’ 메뉴에서 다른 알림 설정 가능
...
* 설치 가능 탭 확인
    ...
    ![image11.png](https://kayoungkimjs.github.io/static/395832e69622cfb5bffd65522715fef3/d9199/image11.png align="left")
...
* NodeJs 항목
    ...
    ![image12.png](https://kayoungkimjs.github.io/static/c4a31efb40f1dff6a8262b305017e490/d9199/image12.png align="left")
...
* 3-1. Add build step
    ...
    ![image14.png](https://kayoungkimjs.github.io/static/7f4f5c2680fa52b47ee5e8bc577a7d13/d9199/image14.png align="left")
    
    Add build step 버튼 클릭 후 execute NodeJs script 선택
    
* 3-2. Execute NodeJs script NodeJS Script 는 3 항목(Execute Shell) 에서 입력
    
    ![image15.png](https://kayoungkimjs.github.io/static/b61787b8582e1acb2284f7b6cd7ec098/d9199/image15.png align="left")
    
    1. NodeJs Installation
        
    2. NodeJs 빌드 설정 에서 생성한 nodeJs 선택
        
* 3-3. Execute Shell **Command**실행할 빌드 스크립트 입력`ex) npm i / npm run build`
    
    ![image16.png](https://kayoungkimjs.github.io/static/7f94686ce85a40b1317aeee02573b34a/d9199/image16.png align="left")