---
title: "Amazon Web Service(AWS) 주요 서비스"
datePublished: Tue May 02 2023 15:00:00 GMT+0000 (Coordinated Universal Time)
cuid: cm2rju83c000009mofzndgj7y
slug: amazon-web-service
tags: aws

---

> AWS의 주요 서비스에는 가상 서버(**EC2**), 스토리지(**S3**, **EBS**), 데이터베이스(**RDS**, **DynamoDB**), 네트워킹(**VPC**, **ELB**), 보안 및 자격 증명(**IAM**), 서버리스 컴퓨팅(**Lambda**), 애플리케이션 통합(**SQS**, **SNS**), 모니터링(**CloudWatch**) 등이 포함된다.
