...
datePublished: Tue Sep 05 2023 15:00:00 GMT+0000 (Coordinated Universal Time)
cuid: cm2rk6hi8000009l4b6vj0v8x
slug: css-scroll-snap
tags: css, scroll-snap

---

> *fullllpage 형식 페이지 구성시, 스크롤 되는 위치에 화면이 자연스럽게 위치되도록 도와주는 CSS 속성이다. 별도 API를 사용하거나 자바스크립트로 요소 위치를 계산할 필요 없이 간편하게 사용할 수 있다.*

![](https://kayoungkimjs.github.io/7791c366e43972710c6ebc6a033cca8b/image.gif align="left")
...
* 참고: [https://developer.mozilla.org/en-US/docs/Web/CSS/CSS\_Scroll\_Snap](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Scroll_Snap)